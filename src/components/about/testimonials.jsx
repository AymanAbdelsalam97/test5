    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        ...
        <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
          <figure className="flex flex-col items-center justify-center p-8 text-center border-b border-gray-200 bg-gray-50 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
          ...
          <figure className="flex flex-col items-center justify-center p-8 text-center border-b border-gray-200 bg-gray-50 md:p-12 dark:bg-gray-800 dark:border-gray-700">
            <blockquote className="max-w-2xl mx-auto mb-8 text-gray-500 dark:text-gray-400">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
          ...
          <figure className="flex flex-col items-center justify-center p-8 text-center border-b border-gray-200 bg-gray-50 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
            <blockquote className="max-w-2xl mx-auto mb-8 text-gray-500 dark:text-gray-400">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
          ...
          <figure className="flex flex-col items-center justify-center p-8 text-center border-gray-200 bg-gray-50 md:p-12 dark:bg-gray-800 dark:border-gray-700">
            <blockquote className="max-w-2xl mx-auto mb-8 text-gray-500 dark:text-gray-400">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
